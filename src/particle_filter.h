...
public:
	// It holds the default number of particles.
	static const int NUMPARTICLES = 127;
	
	// Constant used as a threshold to avoid division by zero.
	static const double EPSILON_CTE;
